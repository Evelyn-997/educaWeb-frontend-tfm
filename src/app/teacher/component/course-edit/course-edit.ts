...
@Component({
  ...
  imports: [CommonModule, RouterModule, ReactiveFormsModule,FormsModule , MatProgressSpinnerModule,
    MatFormFieldModule, MatCell, MatTableModule, MatIconModule],
...
courseForm!: FormGroup;
  ...
  addStudent(): void {
    this.router.navigate(['/teacher/courses/',this.courseId,'add-student']);
  }
